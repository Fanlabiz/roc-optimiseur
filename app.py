...
def place_missing_buildings(placed, buildings_def, terrain_grid, max_r, max_c,
    ...
    def ffd_pure(nn_ordered, n_ordered):
        ...
        # Un culturel va en Phase 1 (bordure) si :
        # - sa puissance est <= seuil (culturel "faible"), OU
        # - sa surface est >= 9 (grand bâtiment 3x3+) : il doit être placé tôt
        #   car il ne trouvera plus de bloc contigu une fois le terrain fragmenté.
