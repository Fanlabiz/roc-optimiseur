...
(function () {
    ...
    function runOptimization(){
        ...
        setTimeout(function(){
            ...
            // En mode no_reduction : calculer les boosts initiaux APRÈS placeMissingBuildings
            if(modalMode==='no_reduction'){
                ...
                placed.forEach(function(b){
                    ...
                    b.boost_min_cat=cat; // garder la catégorie pour débogage
                });
            }
        ...
        setTimeout(function(){
            ...
            try{
                wb = buildExcelOutput(
                    ...
                    prio_par_type, modalMode, window._rocProtected||{});
            }catch(e){
